...
<div id="body">
    	...
    	<div class="wrapper">
    		...
    		<ul class="reset" id="navheader">
    			...
    			<c:if test="${not empty sessionScope.userinfo }">
    				    			<li ><a href="jobSeeker/myResume.jsp" rel="nofollow">我的简历</a></li></c:if>
    ...
    <div id="container">
       	...
       	<div class="sidebar">
                   ...
                   <dt>月薪范围 <em ></em></dt>
	                <dd >
	                <%-- <a class="jobsal"  href="${pageContext.request.contextPath }/jobinfo/search.action?jobvo.Sal=1"> --%>
	                    	                    	<div> 2k以下</div>
	                    	                    	<div>2k-5k</div>
	                    	                    	<div>5k-10k</div>
	                    	                    	<div>10k-15k</div>
        ...
        <div class="content">
        	<div id="search_box">
		 <form id="search_Form" name="search_Form" action="${pageContext.request.contextPath}/jobinfo/search.action" method="post">
  <ul id="searchType">
    <li data-searchtype="1" class="type_selected">职位</li>
     <li data-searchtype="4">公司</li>
       </ul>
  <div class="searchtype_arrow"></div>
  <input type="text" id="search_input" name = "jobvo.jobname"  tabindex="1" value="${sessionScope.jVo.jobname }" <%-- placeholder="${empty sessionScope.jVo.jobname ?  '请输入职位名称，如：产品经理': sessionScope.jVo.jobname } " --%>  />
  <input type="hidden" name="spc" id="spcInput" value="1"/>
  <input type="hidden" name="pl" id="plInput" value=""/>
  <input type="hidden" name="jobvo.typeId" id="typeId" value="${sessionScope.jVo.typeId }"/>
  <input type="hidden" name="jobvo.workEXP" id="gjInput" value="${sessionScope.jVo.workEXP }"/>
  <input type="hidden" name="jobvo.edu" id="xlInput" value="${sessionScope.jVo.edu }"/>
  <input type="hidden" name="jobvo.Sal" id="yxInput" value="${sessionScope.jVo.Sal }"/>
  <input type="hidden" name="jobvo.jobProp" id="gxInput" value="${sessionScope.jVo.jobProp }" />
  <input type="hidden" name="jobvo.Date" id="stInput" value="${sessionScope.jVo.Date }" />
  <input type="hidden" name="labelWords" id="labelWords" value="label" />
  <input type="hidden" name="lc" id="lc" value="" />
  <input type="hidden" name="workAddress" id="workAddress" value=""/>
    <input type="hidden" name="jobvo.city" id="cityInput" value="${sessionScope.jVo.city }"/>
...
<dl class="hotSearch">
	<dt>热门搜索：</dt>
	<dd><a href="/lagou/commonJsp/jobList.jsp">Java</a></dd>
	...
	<dd><a href="list.jsp?gx=实习&city=全国">实习</a></dd>
            ...
            <dl class="workplace" id="workplaceSelect">
                <dt class="fl">工作地点：</dt>
               	               	<dd >
                	<a href="/lagou/commonJsp/jobList.jsp" class="current">全国</a> 
                	                	|
                	               	</dd>
               	               	<dd >
            ...
            <div id="tip_didi" class="dn">
            	...
            	<a href="javascript:;">我知道了</a>
            	            ...
            	            <c:forEach items="${ requestScope.jobinfoList}" var="jobinfo" varStatus="status">
            	            
            	            <li class="${status.count mod 2 eq 1? 'odd ' :''}clearfix">
			                			                				                	<div class="hot_pos_l">
			                        <div class="mb10">
			                            <a href="jobinfo/findbyid.action?jobId=${jobinfo.jobId }" title="前端开发" >${jobinfo.jobName }</a> 
			                            &nbsp;
			                            <span class="c9">[${jobinfo.jobCity }]</span>
			                            			                        </div>
			                        <span><em class="c7">月薪：</em>${jobinfo.jobLowsal/1000 }k-${jobinfo.jobHighsal/1000}k</span>
			                        <span><em class="c7">经验：</em> ${jobinfo.jobexp.expName }</span>
			                        <span><em class="c7">最低学历： </em>${jobinfo.jobedu.eduName }</span>
			                        <br />
			                        <span><em class="c7">职位诱惑：</em>${jobinfo.jobAdvantage }</span>
			                        <br />
			                        <span>1天前发布</span>
			                    </div> 
						        <div class="hot_pos_r">
			                        ...
			                        <div class="mb10"><a href="/lagou/jobSeeker/companyDetailInfor.jsp" title="紫色医疗" >${jobinfo.companyinfo.companyName}</a></div>
			                        <span><em class="c7">领域： </em>${jobinfo.companyinfo.companyfield.fieldName}</span>
			                        			                        <span><em class="c7">创始人：</em> ${jobinfo.companyinfo.companyName}老总</span>
			                        			                        <br />
			                        <span><em class="c7">阶段： </em>${jobinfo.companyinfo.companystage.stageName}</span>
			                        <span><em class="c7">规模： </em>${jobinfo.companyinfo.companysize.sizeName}</span>
			                        <ul class="companyTags reset">
	                    		                    			                ...
	                    		                    			                <!-- <li class="odd clearfix">
			                			                				                	<div class="hot_pos_l">
			                        <div class="mb10">
			                            <a href="/lagou/commonJsp/jobdetail2.jsp" title="前端开发" >前端开发</a> 
			                            &nbsp;
						        ...
						        <div class="hot_pos_r">
			                        ...
			                        <div class="mb10"><a href="/lagou/jobSeeker/companyDetailInfor.jsp" title="紫色医疗" >紫色医疗</a></div>
			                        ...
			                        <ul class="companyTags reset">
	                    		                    			                ...
	                    		                    			                <li class="clearfix">
			                			                				                	<div class="hot_pos_l">
			                        <div class="mb10">
			                            <a href="/lagou/commonJsp/jobdetail1.jsp" title="前端开发" target="_blank">前端开发</a> 
			                            &nbsp;
			                            <span class="c9">[北京]</span>
			                            			                        </div>
						        ...
						        <div class="hot_pos_r">
			                        ...
			                        <ul class="companyTags reset">
	                    		                    			                ...
	                    		                    			                <li class="odd clearfix">
			                			                				                	<div class="hot_pos_l">
			                        <div class="mb10">
			                            <a href="/lagou/commonJsp/jobdetail.jsp" title="高级web前端开发工程师" target="_blank">高级web前端开发工程师</a> 
			                            &nbsp;
...
$(function(){
	...
	$('#options dd div').click(function(){
		...
		if (fn=="月薪范围"){
			editForm("yxInput" ,$("dd div").index($(this))+1);	
		}
		else if(fn=="工作经验"){
			editForm("gjInput" ,$("dd div").index($(this))-6);	
		}
		else if(fn=="最低学历"){
			editForm("xlInput" ,$("dd div").index($(this))-13);
		}
		else if(fn=="工作性质"){
			editForm("gxInput" ,$("dd div").index(this)-18);
		}
		else if(fn=="发布时间"){
			editForm("stInput" ,$("dd div").index(this)-21);
		}
	});
...
function editForm(inputId,inputValue){
	...
	/* if(kw == ''){
		...
		kw = kw.replace(re,'井');
		kw = kw.replace(r,'。');
		$('#search_Form').attr('action','list.jsp'+kw).submit();
	} */
		$('#search_Form').attr('action','${pageContext.request.contextPath}/jobinfo/search.action').submit();	
	//$("#search_Form").submit();
}
</script>
