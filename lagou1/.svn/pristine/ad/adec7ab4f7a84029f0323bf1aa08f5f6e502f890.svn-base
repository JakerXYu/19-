...
<dl class="company_center_aside">
     ...
     <dl>
     	<dt>工作经验：</dt>
         <dd>
         	         	<a rel="-1" class="current" href="/lagou1/findResumeBystatus/haveNoticeResumes.action?jobexp=1&status=5">不限</a>
         	         	<a rel="1" href="/lagou1/findResumeBystatus/haveNoticeResumes.action?jobexp=2&status=5">应届毕业生</a>
         	         	<a rel="2" href="/lagou1/findResumeBystatus/haveNoticeResumes.action?jobexp=3&status=5">一年以下</a>
         	         	<a rel="3" href="/lagou1/findResumeBystatus/haveNoticeResumes.action?jobexp=4&status=5">1-3年</a>
         	         	<a rel="4" href="/lagou1/findResumeBystatus/haveNoticeResumes.action?jobexp=5&status=5">3-5年</a>
         	         	<a rel="5" href="/lagou1/findResumeBystatus/haveNoticeResumes.action?jobexp=6&status=5">5-10年</a>
         	         	<a rel="6" href="/lagou1/findResumeBystatus/haveNoticeResumes.action?jobexp=7&status=5">10年以上</a>
     ...
     <dl>
     	<dt>最低学历：</dt>
         <dd>
         	         	<a rel="-1" class="current" href="/lagou1/findResumeBystatus/haveNoticeResumes.action?jobedu=5&status=5">不限</a>
         	         	<a rel="1" href="/lagou1/findResumeBystatus/haveNoticeResumes.action?jobedu=1&status=5">大专及以上</a>
         	         	<a rel="2" href="/lagou1/findResumeBystatus/haveNoticeResumes.action?jobedu=2&status=5">本科及以上</a>
         	         	<a rel="3" href="/lagou1/findResumeBystatus/haveNoticeResumes.action?jobedu=3&status=5">硕士及以上</a>
         	         	<a rel="4" href="/lagou1/findResumeBystatus/haveNoticeResumes.action?jobedu=4&status=5">博士及以上</a>
