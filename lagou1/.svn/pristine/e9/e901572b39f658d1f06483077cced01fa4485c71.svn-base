    		...
    		<ul id="navheader" class="reset">
    			...
    			<li class="current"><a href="/lagou/commonJsp/companylist.jsp">公司</a></li>
	    				...
	    				<a rel="nofollow" href="/lagou/HR/canDealResumes.jsp">简历管理</a>
	    							    			...
	    							    			<li><a rel="nofollow" href="/lahou/HR/createResume.jsp">发布职位</a></li>
	    		    		</ul>
    ...
    <div id="container">
        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                <dt>
                    <h2><em></em>填写公司信息</h2>
                    <a class="c_addjob" href="/lahou1/HR/createResume.jsp"><i></i>发布新职位</a>
                </dt>
                <dd>
                    ...
                    <form method="post" action="/lagou1/index.jsp" id="infoForm">
