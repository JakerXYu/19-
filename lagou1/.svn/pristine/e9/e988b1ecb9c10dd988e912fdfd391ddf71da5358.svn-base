...
<body id="login_bg">
	<div class="login_wrapper">
		...
		<div class="login_box">
        	<form id="loginForm" action="reg.action" method="post">
            	...
            	<input value="${requestScope.email }" type="text" id="email" name="email" tabindex="1" placeholder="请输入常用邮箱地址"/>
                <span class="error" style="display:none;" id="beError"></span><br>
                <span>${requestScope.usernameExist}</span>
                <input  type="password" id="password" name="password" tabindex="2" placeholder="请输入密码" />
                <input  type="password" id="password" name="password1" tabindex="3" placeholder="请输入密码" />
