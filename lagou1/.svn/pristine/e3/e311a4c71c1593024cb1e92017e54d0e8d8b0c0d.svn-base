	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li class="current"><a href="/lagou1/companylist.jsp">公司</a></li>
    				    			<li>
	    				<a rel="nofollow" href="/lagou1/HR/canDealResumes.jsp">简历管理</a>
	    					    			</li>
	    							    			<li><a rel="nofollow" href="/lagou1/HR/createResume.jsp">发布职位</a></li>
	    		    		</ul>
        	        	<dl class="collapsible_menu">
            	<dt>
           			<span>${sessionScope.companyinfo.companyName},欢迎你</span> 
            		<span class="red dn" id="noticeDot-1"></span>
            		<i></i>
            	</dt>
                                	<dd><a href="/lagou1/HR/existPositions.jsp">我发布的职位</a></dd>
                	<dd><a href="/lagou1/HR/canDealResumes.jsp">我收到的简历</a></dd>
                	<dd class="btm"><a href="/lagou1/myhome.jsp">我的公司主页</a></dd>
                	<dd><a href="/lagou1/commonJsp/jobList.jsp">我要找工作</a></dd>
                                                <dd><a href="accountBind.jsp">帐号设置</a></dd>
                                <dd class="logout"><a rel="nofollow" href="jobSeeker/exit.action">退出</a></dd>
            </dl>
                                </div>
    </div><!-- end #header -->
    <div id="container">
        ...
        <div class="content_mid">
        	<dl class="c_section c_section_mid">
                ...
                <dd>
	                <form id="stepForm" action="/lagou1/companyinfo/update.action" enctype="multipart/form-data" method="post">
	                   ...
	                   <!--  <h3>公司简称</h3> 非必填
	                    	...
	                    	<a title="上传公司LOGO" class="inline cboxElement" href="#logoUploader">
		                        <div id="logoNo">
		                    		<span>上传公司LOGO</span> <br>
							                            尺寸：190*190px  <br>
							                            大小：小于5M
							  <input type="file" value="" id="" name="companylogo"/>
								</div>
	                    ...
	                    <h3>所在城市</h3>
	                    <input type="text" placeholder="请输入工作城市，如：北京" name="cityId" id="cityId">	
	                    
	                    <h3>行业领域</h3>
	                    <div>
		                  <select id="Companyfield.id"  name="fieldId" class="from-control">
		                  <c:forEach items="${applicationScope.fieldlist }" var="Companyfield">
		                  <option value="${Companyfield.fieldId }">${Companyfield.fieldName}</option>
		                  </c:forEach>
		                    </select>
		                    </div>                   
	                    <h3>公司规模</h3>
	                    <div>
		                 <select id="Companysize.id"  name="sizeId" class="from-control">
		                  <c:forEach items="${applicationScope.sizeliList }" var="Companysize">
		                  <option value="${Companysize.sizeId }">${Companysize.sizeName}</option>
		                  </c:forEach>
		                    </select>
		                    </div>	
	                    ...
	                    <h3>发展阶段</h3> 
	                    <div>
		                 <select id="Companystage.id"  name="stageId" class="from-control">
		                  <c:forEach items="${applicationScope.stagelist }" var="Companystage">
		                  <option value="${Companystage.stageId }">${Companystage.stageName}</option>
		                  </c:forEach>
		                    </select>
	                    </div>
	                    ...
	                    <input type="submit" id="stepBtn"  value="保存，下一步"  class="btn_big fr" ><!-- type="submit"  id="stepBtn" -->
