    		...
    		<ul id="navheader" class="reset">
            	...
            	<dt>
            		...
            		<i></i>
                                	...
                                	<!-- <dd><a rel="nofollow" href="lagou1/jobSeeker/myResume.jsp">我的简历</a></dd>
                	...
                	<dd><a href="create.jsp">我要招人</a></dd>
                                ...
                                <dd class="logout"><a rel="nofollow" href="/lagou1/login.jsp">退出</a></dd>
            </dl>
                                    <div id="noticeTip">
            	<span class="bot"></span>
				<span class="top"></span>
...
<dl class="company_center_aside">
            ...
            <div class="content">
            	<dl class="company_center_content">
                    <dt>
                        <h1>
                            <em></em>
                            	待定简历  <span>（共${fn:length(requestScope.resumeList)}份）</span>                        </h1>
                    </dt>
                    <dd>
     ...
     <dl>
     	<dt>工作经验：</dt>
         <dd>
         	         	<a rel="-1" class="current" href="/lagou1/findResumeBystatus/canInterviewResumes.action?jobexp=1&status=4">不限</a>
         	         	<a rel="1" href="/lagou1/findResumeBystatus/canInterviewResumes.action?jobexp=2&status=4">应届毕业生</a>
         	         	<a rel="2" href="/lagou1/findResumeBystatus/canInterviewResumes.action?jobexp=3&status=4">一年以下</a>
         	         	<a rel="3" href="/lagou1/findResumeBystatus/canInterviewResumes.action?jobexp=4&status=4">1-3年</a>
         	         	<a rel="4" href="/lagou1/findResumeBystatus/canInterviewResumes.action?jobexp=5&status=4">3-5年</a>
         	         	<a rel="5" href="/lagou1/findResumeBystatus/canInterviewResumes.action?jobexp=6&status=4">5-10年</a>
         	         	<a rel="6" href="/lagou1/findResumeBystatus/canInterviewResumes.action?jobexp=7&status=4">10年以上</a>
     ...
     <dl>
     	<dt>最低学历：</dt>
         <dd>
         	         	<a rel="-1" class="current" href="/lagou1/findResumeBystatus/canInterviewResumes.action?jobedu=5&status=4">不限</a>
         	         	<a rel="1" href="/lagou1/findResumeBystatus/canInterviewResumes.action?jobedu=1&status=4">大专及以上</a>
         	         	<a rel="2" href="/lagou1/findResumeBystatus/canInterviewResumes.action?jobedu=2&status=4">本科及以上</a>
         	         	<a rel="3" href="/lagou1/findResumeBystatus/canInterviewResumes.action?jobedu=3&status=4">硕士及以上</a>
         	         	<a rel="4" href="/lagou1/findResumeBystatus/canInterviewResumes.action?jobedu=4&status=4">博士及以上</a>
 ...
 <c:forEach items="${requestScope.resumeList }" var="resume">
			                                ...
			                                <div class="contactInfo">
			                                	<span class="c9">电话：</span>${resume.resumeinfo.userinfo.userinfoPhone }   &nbsp;&nbsp;&nbsp;   
			                                    <span class="c9">邮箱：</span><a href="mailto:${resume.resumeinfo.userinfo.userinfoEmail }">${resume.resumeinfo.userinfo.userinfoEmail }</a>
			                                </div>
			                                </c:forEach>
			                                <!-- 循环结束 -->
			                            </li>
