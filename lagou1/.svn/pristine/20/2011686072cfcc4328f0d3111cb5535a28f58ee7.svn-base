...
<div id="body">
    ...
    <div id="container">
                	<div class="sidebar">
            	<a class="btn_create" href="/lagou/HR/createResume.jsp">发布新职位</a>
...
<dl class="company_center_aside">
		<dt>我发布的职位</dt>
			<dd class="current">
		<a href="existPositions.jsp">有效职位</a>
	</dd>
	<dd>
            ...
            <div class="content">
            	<dl class="company_center_content">
                    <dt>
                        <h1>
                            <em></em>
                           有效职位 <span>（共<i style="color:#fff;font-style:normal" id="positionNumber">${fn:length(requestScope.jobinfolist)}</i>个）</span>                        </h1>
                    </dt>
                    <dd>
                    		                    	<form id="searchForm">
	                    		<input type="hidden" value="Publish" name="type">
			                	<ul class="reset my_jobs">
			                	<c:forEach items="${requestScope.jobinfolist}" var ="job">
			                	
				                			                            	<li data-id="149594">
		                                    <h3>
		                                        <a target="_blank" title="${job.jobName}" href="#">${job.jobName}</a> 
		                                        <span>[${job.jobCity}]</span>
		                                        						                        		                                    </h3>
		                                    		                                  		<span class="receivedResumeNo"><a href="unHandleResumes.jsp?positionId=149594">应聘简历（1）</a></span>
              			                                    <div>${job.jobprop.propName}/ ${job.jobLowsal}-${job.jobHighsal} / ${job.jobexp.expName} /  ${job.jobedu.eduName}</div>
		                                    		                                    				                                    <div class="c9">发布时间： 2017-06-13 11:07:01</div>
			                                    		                                    		                                    		                                    <div class="links">
