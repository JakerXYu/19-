            ...
            <div class="content_l">
            	<div class="fl" id="resume_name">
	            	<div class="nameShow fl">
	            		<h1 title="我的简历">${requestScope.resumeinfo.userinfo.userinfoUsername }的简历</h1>
	            		<span class="rename">重命名</span> | <a target="_blank" href="preview.jsp">预览</a>
            		</div>
            		<form class="fl dn" id="resumeNameForm">
            			<input type="text" value="我的简历" name="resumeName" class="nameEdit c9">	
            	...
            	<div class="profile_box" id="basicInfo">
            		...
            		<div class="basicShow">
            			<span>${requestScope.resumeinfo.userinfo.userinfoUsername } | 
            				 ${requestScope.resumeinfo.userinfo.userinfoSex } |
            			 	${requestScope.resumeinfo.useredu.jobedu.eduName }|
            				${requestScope.resumeinfo.userinfo.userinfoExp }年工作经验<br>
            			    ${requestScope.resumeinfo.userinfo.userinfoPhone } | 
            			    ${requestScope.resumeinfo.userinfo.userinfoEmail }<br>
            			 </span>   
            		...
            		<div class="basicEdit dn" style="hegiht:480px">
            			<form  action="/lagou1/resumeinfo/updateUser.action" method="post" style="width:450px">
						  <input type="submit" value="保存" hidden>
						  <table>
						    <tbody><tr>
						      <td valign="top">
						      <input type="submit" value="保存"  class="btn_profile_save" hidden>
						        <span class="redstar">*</span>
						      </td> 
						      <td>
						        <input type="text" placeholder="姓名" value="${requestScope.resumeinfo.userinfo.userinfoUsername }" name="resumeinfo.userinfo.userinfoUsername" id="name" style="width:190px;hight:46px">
						      </td>
						      <td valign="top"></td> 
						      <td>
						          <ul class="profile_radio clearfix reset">
						            <li class="current">
						           	  	 男<em></em>
						              	<input type="radio" checked="checked" name="resumeinfo.userinfo.userinfoSex" value="男"> 
						            </li>
						            <li>
						            	  女<em></em>
						              	<input type="radio" name="resumeinfo.userinfo.userinfoSex" value="女"> 
						            </li>
						          </ul>  
						      </td>
						    </tr>
						    <tr>
						      ...
						      <td>
						      	<input type="hidden" id="topDegree" value="${requestScope.resumeinfo.userinfo.userinfoEdu }" name="topDegree">
						        <input type="button" value="${requestScope.resumeinfo.userinfo.userinfoEdu }" id="select_topDegree" class="profile_select_190 profile_select_normal">
						    ...
						    <tr>
						      ...
						      <td colspan="3">
						          <input type="text" placeholder="手机号码" value="18644444444" name="resumeinfo.userinfo.userinfoPhone" id="tel">
						      </td>
						   	</tr>
						   	<tr>
						      <td valign="top">
						      ...
						      <td colspan="3">
						          <input type="text" placeholder="接收面试通知的邮箱" value="jason@qq.com" name="resumeinfo.userinfo.userinfoEmail" id="email">
						      </td>
						    </tr>
						    <tr>
						      <td valign="top"> </td> 
						...
						<div class="new_portrait">
						  ...
						  <input type="file" value="" title="支持jpg、jpeg、gif、png格式，文件小于5M" onchange="img_check(this,'h/resume/uploadPhoto.json','headPic');" name="headPic" id="headPic" class="myfiles" hidden>
	            			...
	            			<table>
	            				<tbody><tr>
	            					<td>
	            						...
	            						<input type="button" value="期望城市，如：北京" id="select_expectCity" class="profile_select_287 profile_select_normal" name="resumeinfo.expectjob.cityinfo.cityName">
