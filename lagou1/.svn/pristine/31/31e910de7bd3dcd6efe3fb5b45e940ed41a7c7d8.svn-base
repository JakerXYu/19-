		...
		<div id="header">
			<div class="wrapper">
				...
				<ul id="navheader" class="reset">
					...
					<!-- <li><a rel="nofollow" href="/lagou1/jobSeeker/myResume.jsp">简历管理</a>
					</li> -->
				...
				<dl class="collapsible_menu">
					...
					<dd style="display: none;">
						<a href="/lagou1/HR/existPositions.jsp">我发布的职位</a>
					</dd>
					<dd style="display: none;">
						<a href="/lagou1/HR/canDealResumes.jsp">我收到的简历</a>
					</dd>
					<dd class="btm" style="display: none;">
						<a href="/lagou1/myhome.jsp">我的公司主页</a>
					</dd>
					<dd style="display: none;">
						<a href="/lagou1/commonJsp/jobList.jsp">我要找工作</a>
					</dd>
					<dd style="display: none;">
						<a href="accountBind.jsp">帐号设置</a>
					</dd>
					<dd class="logout" style="display: none;">
						<a rel="nofollow" href="jobSeeker/exit.action">退出</a>
					</dd>
				</dl>
			</div>
		</div>
		...
		<div id="container">
			...
			<div class="sidebar">
				...
				<dl class="company_center_aside">
					...
					<dd>
						<a
							href="/lagou1/findResumeBystatus/canDealResumes.action?status=2">待处理简历</a>
					</dd>
					<dd>
						<a
							href="/lagou1/findResumeBystatus/canInterviewResumes.action?status=4">待定简历</a>
					</dd>
					<dd>
						<a
							href="/lagou1/findResumeBystatus/haveNoticeResumes.action?status=5">已通知面试简历</a>
					</dd>
					<dd>
						<a
							href="/lagou1/findResumeBystatus/findByResumeStatuss.action?status=6">不合适简历</a>
					</dd>
				...
				<dl class="company_center_aside">
					<dt>我发布的职位</dt>
					<dd>
					    <a href="companyjobinfo/find.action?status=1">有效职位</a>
						<!-- <a href="/lagou1/HR/existPositions.jsp">有效职位</a> -->
					</dd>
					<dd>
					<a href="companyjobinfo/find.action?status=2">已下线职位</a>
			...
			<div class="content">
				<dl class="company_center_content">
					...
					<dd>
						...
						<form action="jobinfo/releasePosition.action" method="post"
							id="jobForm">
							<input type="hidden" value="" name=""> <input
								type="hidden" value="create" name=""> <input
								type="hidden" value="25927" name=""> <input
							...
							<table class="btm">
								<tbody>
									...
									function getjobtypeId2(li_obj){
	                    			var input_obj=document.getElementById("positionTypeId");
									input_obj.value=li_obj.value;
	                    			}
									</script>
									 
									<input type="hidden"
											id="positionTypeId" value="" name="jobtypeId"> 
											<input type="button" value="请选择职位类别" id="select_category"
											class="selectr selectr_380">
											<div class="dn" id="box_job" style="display: none;">

												<c:forEach items="${applicationScope.typelvlist }"
													var="lvlist">
													<dl>
														<dt value="${lvlist.typeId }">${lvlist.typeName }</dt>
														<dd>
															<ul class="reset job_main">
																<c:forEach items="${lvlist.jobtypes }" var="path"
																	varStatus="ss">
																	<li><span>${path.typeName }</span> <c:choose>
																			<c:when test="${(ss.index+1)mod 3 }eq1">

																				<ul class="reset job_sub dn">
																					<c:forEach items="${path.jobtypes }" var="pathName">
																						<li title="${pathName.typeId}" value="${pathName.typeId}"
																							onclick="getjobtypeId2(this)">${pathName.typeName}</li>
																					</c:forEach>
																				</ul>
																			</c:when>
																			<c:when test="${(ss.index+1)mod 3 }eq2">
																				<ul class="reset job_sub dn"
									...
									<tr>
										...
										<td><input type="text" placeholder="请输入职位名称，如：产品经理"
											value="" name="jobinfo.jobName" id="positionName"></td>
									</tr>
									<tr>
										<td></td>
										<td>所属部门</td>
										<td><input type="text" placeholder="请输入所属部门" value=""
											name="jobinfo.jobDepartment" id="department"></td>
									</tr>
								</tbody>
							</table>
							...
							<table class="btm">
								<tbody>
									<tr>
										...
										<td>
									<script type="text/javascript">
									function getjobprop(li_job){
	                    			var input_obj=document.getElementById("get_jobpropId");
									input_obj.value=li_job.value;
	                    			}
									</script> 
									<input type="hidden" value="" id="get_jobpropId"
											name="jobpropId">
											<ul class="profile_radio clearfix reset">
												<li>全职<em></em> <input type="radio"
													value="1" onclick="getjobprop(this)">
												</li>
												<li>兼职<em></em> <input type="radio" 
													value="2" onclick="getjobprop(this)">
												</li>
												<li>实习<em></em> <input type="radio" 
													value="3" onclick="getjobprop(this)">
												</li>
											</ul></td>
									</tr>
									<tr>
											...
											<div class="salary_range">
												<div>
													<input type="text" placeholder="最低月薪" value=""
														id="salaryMin" name="jobinfo.jobLowsal"> <span>k</span>
												</div>
												<div>
													<input type="text" placeholder="最高月薪" value=""
														id="salaryMax" name="jobinfo.jobHighsal"> <span>k</span>
												</div>
									...
									<tr>
										...
										<td><input type="text" placeholder="请输入工作城市，如：北京"
											value="上海" name="jobinfo.jobCity" id="workAddress"></td>
									</tr>
								</tbody>
							</table>
							...
							<table class="btm">
								<tbody>
									...
									function get_li(li_obj){
	                    			var var_obj=document.getElementById("get_li_Id");
									var_obj.value=li_obj.value;
	                    			}
									</script> <input type="hidden" id="get_li_Id" value=""
											name="jobexpId"> <input type="button"
											value="请选择工作经验" id="select_experience"
											class="selectr selectr_380">
											<div class="boxUpDown boxUpDown_380 dn" id="box_experience"
												style="display: none;">
												<ul>
													<li title="1" value="1" onclick="get_li(this)">不限</li>
													<li title="2" value="2" onclick="get_li(this)">应届毕业生</li>
													<li title="3" value="3" onclick="get_li(this)">1年以下</li>
													<li title="4" value="4" onclick="get_li(this)">1-3年</li>
													<li title="5" value="5" onclick="get_li(this)">3-5年</li>
													<li title="6" value="6" onclick="get_li(this)">5-10年</li>
													<li title="7" value="7" onclick="get_li(this)">10年以上</li>
												</ul>
											</div></td>
									</tr>
									<tr>
										...
										<!--<h3><span>(最高月薪不能大于最低月薪的2倍)</span></h3> -->
										<td><script type="text/javascript">
									function get_li2(li_obj){
	                    			var var_obj=document.getElementById("get_li2_Id");
									var_obj.value=li_obj.value;
	                    			}
									</script> <input type="hidden" id="get_li2_Id" value=""
											name="jobeduId"> <input type="button"
											value="请选择学历要求" id="select_education"
											class="selectr selectr_380">
											<div class="boxUpDown boxUpDown_380 dn" id="box_education"
												style="display: none;">
												<ul>
													<li title="1" value="1" onclick="get_li2(this)">不限</li>
													<li title="2" value="2" onclick="get_li2(this)">大专</li>
													<li title="3" value="3" onclick="get_li2(this)">本科</li>
													<li title="4" value="4" onclick="get_li2(this)">硕士</li>
													<li title="5" value="5" onclick="get_li2(this)">博士</li>
												</ul>
											</div></td>
									</tr>
								</tbody>
								...
								<tbody>
									<tr>
										...
										<td><input type="text"
											...
											name="jobinfo.jobAdvantage" class="input_520"
									...
									<tr>
										...
										<td><span class="c9 f14">(建议分条描述工作职责等。请勿输入公司邮箱、联系电话及其他外链，否则将自动删除)</span>
											<input type="text" width="30px" height="10px" value=""
											name="jobinfo.jobDescripe" /></td>
									</tr>
									<tr>
										<td><span class="redstar">*</span></td>
										<td>工作地址</td>
										<td><input type="text" placeholder="请输入详细的工作地址" value=""
											name="jobinfo.jobAddress" class="input_520"
											id="positionAddress"> <input type="hidden" value=""
											name="" id="lng"> <input type="hidden"
											value="" name="" id="lat">
								...
								<tbody>
									<tr>
										...
										<td colspan="2">接收简历邮箱： <span id="receiveEmailVal">admin@admin.com</span>
											...
											id="receiveEmail" name="">
										</td>
									</tr>
									<tr>
										<td width="25"></td>
										<td colspan="2">同时简历自动发送至邮箱（仅一个） <input type="text"
											value="" id="forwardEmail" name="jobinfo.jobEmail"> <!-- <span class="error" id="beError" style="display:none"></span> -->
										</td>
									</tr>
									<tr>
										<td width="25"></td>
									<script type="text/javascript">
									function get_inp(li_obj){
	                    			var var_obj=document.getElementById("get_li2_Id2");
									var_obj.value=li_obj.value;
	                    			}
									</script>
										<td colspan="2"><input type="hidden" id="get_li2_Id2"
											value="" name="jobstatusId"> 紧急：<input
											type="radio" value="1" class="btn_3" onclick="get_inp(this)">普通：<input
											type="radio" value="2" class="btn_3" onclick="get_inp(this)"><br>
											<input type="submit" value="发布" id="formSubmit"
											class="btn_32"></td>
									</tr>
								</tbody>
							</table>
