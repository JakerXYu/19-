    		...
    		<ul id="navheader" class="reset">
            	...
            	<dt>
            		...
            		<i></i>
                                	...
                                	<dd style="display: none;"><a href="/lagou/HR/existPositions.jsp">我发布的职位</a></dd>
                	<dd style="display: none;"><a href="/lagou/HR/canDealResumes.jsp">我收到的简历</a></dd>
                	<dd class="btm" style="display: none;"><a href="/lagou/myhome.jsp">我的公司主页</a></dd>
                	<dd style="display: none;"><a href="/lagou/commonJsp/jobList.jsp">我要找工作</a></dd>
                                                <dd style="display: none;"><a href="accountBind.jsp">帐号设置</a></dd>
                                <dd class="logout" style="display: none;"><a rel="nofollow" href="/lagou/login.jsp">退出</a></dd>
            </dl>
                                </div>
    </div><!-- end #header -->
    <div id="container">
