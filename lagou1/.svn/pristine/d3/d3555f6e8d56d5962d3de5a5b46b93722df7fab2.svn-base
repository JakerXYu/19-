...
import com.lagou.domain.Message;
...
public class MessageDAO {
	...
	public List<Message> findByExample(Message instance) {
		...
		try {
			List<Message> results = (List<Message>) getCurrentSession()
					.createCriteria("com.lagou.domain.Message")
	...
	public List<Message> findByMessageContent(Object messageContent) {
