	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li class="current"><a href="/lagou/commonJsp/companylist.jsp">公司</a></li>
    				    			<li>
	    				<a rel="nofollow" href="/lagou/HR/canDealResumes.jsp">简历管理</a>
	    					    			</li>
	    							    			<li><a rel="nofollow" href="/lagou/HR/createResume.jsp">发布职位</a></li>
	    		    		</ul>
            	...
            	<dt>
            		...
            		<i></i>
                                	...
                                	<dd><a href="/lagou/HR/existPositions.jsp">我发布的职位</a></dd>
                	<dd><a href="/lagou/HR/canDealResumes.jsp">我收到的简历</a></dd>
                	<dd class="btm"><a href="/lagou/myhome.jsp">我的公司主页</a></dd>
                	<dd><a href="/lagou/commonJsp/jobList.jsp">我要找工作</a></dd>
    ...
    <div id="container">
        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                <dt>
                    <h2><em></em>填写公司信息</h2>
                    <a class="c_addjob" href="/lahou/HR/createResume.jsp"><i></i>发布新职位</a>
                </dt>
                <dd>
                	<div class="c_text">目标明确、前途光明的产品是吸引求职者的制胜法宝哦！</div>
                 	<img width="668" height="56" class="c_steps" alt="第四步" src="style/images/step4.png">
                    
                    <form method="post" action="/lagou1/HR/companyIntroduce.jsp" id="productForm">
                    	...
                    	<input type="submit" value="保存，下一步" id="step4Submit" class="btn_big fr" ><!-- id="step4Submit" -->
                    	<a class="btn_cancel fr" href="/lagou1/HR/companyIntroduce.jsp">跳过</a>
                    </form>
                </dd>
            </dl>
       	</div>
