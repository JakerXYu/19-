    ...
    <div id="container">
        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                <dt>
                    <h2><em></em>填写公司信息</h2>
                    <a class="c_addjob" href="/lagou/HR/createResume.jsp"><i></i>发布新职位</a>
                </dt>
                <dd>
                	<div class="c_text">展示强劲的创始团队，让求职者跟随而来吧！</div>
                 	<img width="668" height="56" class="c_steps" alt="第三步" src="style/images/step3.png">
                    
                    <form method="post" action="/lagou1/HR/companyProduct.jsp" id="memberForm">
                    	...
                    	<a id="addMember" class="add_member" href="javascript:void(0)"><i></i>继续添加创始团队</a>
	                     ...
	                     <script type="text/javascript">
	                    function aaa(){
	                    window.location="/lagou1/HR/companyProduct.jsp";
	                    }
	                    </script>
                   		 
                    	<input type="submit" value="保存，下一步"  class="btn_big fr" onclick="javascript:aaa()"><!-- id="step3Submit" -->
