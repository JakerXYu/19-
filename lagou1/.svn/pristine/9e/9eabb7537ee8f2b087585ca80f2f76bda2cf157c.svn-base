    		...
    		<ul id="navheader" class="reset">
            	...
            	<dt>
            		...
            		<i></i>
                                	...
                                	<dd><a rel="nofollow" href="myResume.jsp">我的简历</a></dd>
                	                	<dd><a href="collectionsRes.jsp">我收藏的职位</a></dd>
                	                	                	<dd class="btm"><a href="subscribeJob.jsp">我的订阅</a></dd>
                	<dd style="display: none;"><a href="/lagou1/HR/createResume.jsp">我要招人</a></dd>
                                                <dd style="display: none;"><a href="/lagou1/accountBind.jsp">帐号设置</a></dd>
  		...
  		<div class="clearfix">
            <div class="content_l">
            	<div class="fl" id="resume_name">
	            	<div class="nameShow fl">
	            		<h1 title="jason的简历">${sessionScope.userinfo.userinfoUsername }的简历</h1>
	            		<span class="rename">重命名</span> | <a target="_blank" href="previewResume.jsp">预览</a>
            		</div>
            		<form class="fl dn" id="resumeNameForm">
            			<input type="text" value="${sessionScope.userinfo.userinfoUsername }的简历" name="resumeName" class="nameEdit c9">	
            			<input type="submit" value="保存"> | <a target="_blank" href="previewResume.jsp">预览</a>
            		</form>
            	</div><!--end #resume_name-->
            	...
            	<div class="profile_box" id="basicInfo">
            		...
            		<div class="basicShow">
            			  <span>${sessionScope.userinfo.userinfoUsername } |
            			  ${sessionScope.userinfo.userinfoSex } |  
            			     
            			      <c:choose>
            			      <c:when test="${sessionScope.userinfo.userinfoEdu eq 1}">大专</c:when>
            			      <c:when test="${sessionScope.userinfo.userinfoEdu eq 2}">本科</c:when>
            			      <c:when test="${sessionScope.userinfo.userinfoEdu eq 3}">硕士</c:when>
            			      <c:when test="${sessionScope.userinfo.userinfoEdu eq 4}">博士</c:when>
            			      <c:otherwise>其他</c:otherwise>
            			      </c:choose>
            			       | 
            			   ${sessionScope.userinfo.userinfoExp }年工作经验<br>
            			  ${sessionScope.userinfo.userinfoPhone }|
            			   ${sessionScope.userinfo.userinfoEmail }<br>
            			</span>
            		...
            		<div class="basicEdit dn">
            			<form id="profileForm" action="/resumeinfo/basicInfo.action" method="post">
            			<input type="submit" value="保存" hidden><input type="submit" hidden>
						  <table>
						    <tbody><tr>
						      <td valign="top">
						    ...
						    <tr>
						      <td></td> 
						      <td colspan="3">
						      <input type="submit" value="保存" hidden>
						          <input type="hidden" value="保 存" class="btn_profile_save">
            		...
            		<input type="hidden" id="nameVal" value="${sessionScope.userinfo.userinfoUsername }">
            		<input type="hidden" id="genderVal" value="${sessionScope.userinfo.userinfoSex } ">
            		<input type="hidden" id="topDegreeVal" value="本科">
            		<input type="hidden" id="workyearVal" value="${sessionScope.userinfo.userinfoExp}年">
            		<input type="hidden" id="currentStateVal" value="">
            		<input type="hidden" id="emailVal" value="${sessionScope.userinfo.userinfoEmail}">
            		<input type="hidden" id="telVal" value="${sessionScope.userinfo.userinfoPhone}">
            	...
            	<div class="profile_box" id="expectJob">
            		...
            		<div class="expectEdit dn">
            			<form id="expectForm" action="/resumeinfo/expectJob.action" method="post">
	            			<table>
	            				<tbody><tr>
	            					<td>
            		...
            		<c:choose>
            		<c:when test="${requestScope.resumeinfo.expectjob eq null }">
            		...
            		工作地点：${requestScope.resumeinfo.expectjob.cityinfo.cityName }<br>
            		工作性质：${requestScope.resumeinfo.expectjob.jobprop.propName }<br>
            		职业名称：${requestScope.resumeinfo.expectjob.expectJobDept}<br>
            		薪资：${ requestScope.resumeinfo.expectjob.sal.salMin}k-${ requestScope.resumeinfo.expectjob.sal.salMax}k<br>
            	...
            	<div class="profile_box" id="workExperience">
            		...
            		<c:otherwise>
            		<div class="experienceAdd pAdd">
            		公司名称：${requestScope.resumeinfo.userworkexp.workexpName }<br>
            		工作名称：${requestScope.resumeinfo.userworkexp.workexpJob }<br>
            		工作开始、结束时间：${requestScope.resumeinfo.userworkexp.workexpBegintime }至${requestScope.resumeinfo.userworkexp.workexpEndtime }<br>
            		</div>
            		</c:otherwise>
            		</c:choose><!--end .experienceAdd-->
            ...
            <div class="content_r">
            	<div class="mycenterR" id="myInfo">
            		<h2>我的信息</h2>
            		<a target="_blank" href="collectionsRes.jsp">我收藏的职位</a>
            		<br>
            		            		            		<a target="_blank" href="/lagou1/jobSeeker/subscribeJob.jsp">我订阅的职位</a>
            	</div><!--end #myInfo-->
...
$(function(){
	...
	<div id="footer">
		<div class="wrapper">
			<a rel="nofollow" target="_blank" href="lagou1/commonJsp/about.jsp">联系我们</a>
