    	...
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
            	...
            	<dt>
                	...
                	<dd><a href="/lagou1/HR/createResume.jsp">我要招人</a></dd>
...
<dl class="company_center_aside">
            ...
            <div class="content">
            	<dl class="company_center_content">
                    <dt>
                        <h1>
                            <em></em>
                           	 不合适简历 <span>（共${fn:length(requestScope.resumeList)}份）</span>                        </h1>
                    </dt>
                    <dd>
     ...
     <dl>
     	<dt>工作经验：</dt>
         <dd>
         	         	<a rel="-1" class="current" href="/lagou1/findResumeBystatus/findByResumeStatuss.action?jobexp=1&status=6">不限</a>
         	         	<a rel="1" href="/lagou1/findResumeBystatus/findByResumeStatuss.action?jobexp=2&status=6" >应届毕业生</a>
         	         	<a rel="2" href="/lagou1/findResumeBystatus/findByResumeStatuss.action?jobexp=3&status=6">一年以下</a>
         	         	<a rel="3" href="/lagou1/findResumeBystatus/findByResumeStatuss.action?jobexp=4&status=6">1-3年</a>
         	         	<a rel="4" href="/lagou1/findResumeBystatus/findByResumeStatuss.action?jobexp=5&status=6">3-5年</a>
         	         	<a rel="5" href="/lagou1/findResumeBystatus/findByResumeStatuss.action?jobexp=6&status=6">5-10年</a>
         	         	<a rel="6" href="/lagou1/findResumeBystatus/findByResumeStatuss.action?jobexp=7&status=6">10年以上</a>
     ...
     <dl>
     	<dt>最低学历：</dt>
         <dd>
         	         	<a rel="-1" class="current" href="/lagou1/findResumeBystatus/findByResumeStatuss.action?jobedu=5&status=6">不限</a>
         	         	<a rel="1" href="/lagou1/findResumeBystatus/findByResumeStatuss.action?jobedu=1&status=6">大专及以上</a>
         	         	<a rel="2" href="/lagou1/findResumeBystatus/findByResumeStatuss.action?jobedu=2&status=6">本科及以上</a>
         	         	<a rel="3" href="/lagou1/findResumeBystatus/findByResumeStatuss.action?jobedu=3&status=6">硕士及以上</a>
         	         	<a rel="4" href="/lagou1/findResumeBystatus/findByResumeStatuss.action?jobedu=4&status=6">博士及以上</a>
