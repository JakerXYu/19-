...
<link rel="Shortcut Icon" href="https://img.lagou.com/passport/static/common/static/favicon_faed927.ico">


<!-- header/global_domain FE_base.. -->

<script src="/v.htm" charset="utf-8"></script>
<script src="style/js/analyticsemail.js" async=""></script>
<script src="style/js/hm.js"></script>
<script src="style/js/a.js" async=""></script>
...
<script type="text/javascript">
    window.X_Anti_Forge_Token = '48cf082a-5d23-4f28-b982-127fc2455ad9';
    window.X_Anti_Forge_Code = '40586326';
</script>
...
<![endif]-->
    ...
    <link rel="stylesheet" type="text/css" href="commonJsp/style/css/step1.css">
</head>
<body>
...
<section style="display: none;" class="content_box" id="findPwd1">
	<!-- 通过手机号找回密码 -->
	<div class="findPwd">
		<h5 class="change_way"><a rel="nofollow" href="https://passport.lagou.com/login/login.html">返回登录</a><span class="separate">|</span><a class="go_mail" rel="nofollow" href="javascript:;" id="go-mail">通过邮箱找回</a></h5>
		<form action="" method="">
			...
			<div class="form_body" data-view="phoneFindStep1">
				<div style="display: block;" class="input_item clearfix" data-propertyname="phone" data-controltype="Phone">
					<input class="input input_white" id="" name="" placeholder="请输入注册时使用的手机号" data-required="required" autocomplete="off" type="text"> 
				</div>
				<div class="input_item clearfix" data-propertyname="request_form_verifyCode" data-controltype="VerifyCode" style="display: block;">
					<input class="input input_white fl" style="width:130px; display:block;" name="" placeholder="请证明你不是机器人" data-required="required" autocomplete="off" type="text"><img src="style/css/create.jpg" class="yzm">
					
					<a rel="nofollow" href="javascript:;" class="reflash"></a>
				</div>
				<div style="display: block;" class="input_item clearfix" data-propertyname="verifyCode" data-controltype="PhoneVerificationCode">
				...
				<div style="display: block;" class="input_item clearfix" data-propertyname="submit" data-controltype="Botton">
					<input class="btn btn_green btn_active btn_block" value="找回密码" type="button">
				</div>
			</div>
			<div class="form_body" style="display:none" data-view="phoneFindStep2">
				<div style="display: block;" class="input_item clearfix" data-propertyname="newpwd" data-controltype="Password">
					<input class="input input_white" id="" name="" placeholder="请输入新密码 " data-required="required" autocomplete="off" type="password"> 
				</div>
				<div style="display: block;" class="input_item clearfix" data-propertyname="newrepwd" data-controltype="RepeatPassword">
					<input class="input input_white" id="" name="" placeholder="请再次输入密码" data-required="required" autocomplete="off" type="password"> 
				</div>
				<div style="display: block;" class="input_item clearfix" data-propertyname="submit" data-controltype="Botton">
					<input class="btn btn_green btn_active btn_block" value="确定" type="button">
				</div>
			</div>
		</form>
	</div>
</section>
<section style="display: block;" class="content_box" id="findPwd2">
	<!-- 通过邮箱来找回密码 -->
	<div class="findPwd">
		<h5 class="change_way"><a rel="nofollow" href="https://passport.lagou.com/login/login.html">返回登录</a><span class="separate">|</span><a class="go_phone" rel="nofollow" href="javascript:;" id="go-phone">通过手机号找回</a></h5>
		<form action="" method="">
			<ul class="form_head clearfix">
			...
			<div class="form_body" data-view="emailFindStep1">
				<div style="display: block;" class="input_item clearfix" data-propertyname="email" data-controltype="Email">
					<input value="1637840441@qq.com" class="input input_white" id="" name="" placeholder="请输入注册时使用的邮箱地址" data-required="required" autocomplete="off" type="text"> 
				</div>
				<div class="input_item clearfix" data-propertyname="request_form_verifyCode" data-controltype="VerifyCode" style="display:none;">
					<input class="input input_white fl" style="width:130px; display:block;" name="" placeholder="请证明你不是机器人" data-required="required" autocomplete="off" type="text"><img src="style/images/create.jpg" class="yzm">
			...
			<div class="form_body" style="display:none">
				...
				<div class="input_item clearfix">
					<input class="btn btn_green btn_active btn_block" value="确定" id="step3" onclick="findByMail('step3')" type="button"> 
				</div>
			</div>
		</form>
	</div>
...
<script type="text/javascript" src="style/js/step1.js"></script>
<script type="text/javascript" src="style/js/static_43ced5b.js"></script>
<script type="text/javascript">
    //login page
    require(['pc/page/findpassword/main']);
</script>
<script type="text/javascript" src="style/js/oss.js"></script>
