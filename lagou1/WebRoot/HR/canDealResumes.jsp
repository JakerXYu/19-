...
<script type="text/javascript">
	$(function() {
		$("#findhot").click(function() {
			$.ajax({
				type : "POST",
				url : "jobinfo/findhot.action",
				data : {
				},
				dataType : "text",
				success : function(data) {
				
					 var jakerposul = document.getElementById("jakerposul1");
					$("#jakerposul1").html("");
					var msg=data.replace(/\*/g,'\/');
					 var msg1=msg.replace(/\"/g,'');
					jakerposul.innerHTML=msg1;
				}
			});
		});
	});
	$(function() {
		$("#findnew").click(function() {
			$.ajax({
				...
				dataType : "text",
				success : function(data) {
					 var jakerposul = document.getElementById("jakerposul2");
					$("#jakerposul2").html("");
					var msg=data.replace(/\*/g,'\/');
					 var msg1=msg.replace(/\"/g,'');
					jakerposul.innerHTML=msg1;
	...
	$(function() {
		$("#findsubs").click(function() {
			$.ajax({
				type : "POST",
				url : "jobinfo/findsubs.action",
				data : {
				},
				dataType : "text",
				success : function(data) {
				  var jakerposul = document.getElementById("jakerposul3");
					$("#jakerposul3").html("");
					var msg=data.replace(/\*/g,'\/');
					 var msg1=msg.replace(/\"/g,'');
					jakerposul.innerHTML=msg1;
...
<div id="body">
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li><a href="/lagou1/common/companylist.jsp">公司</a></li>
    			<li class="current"><a rel="nofollow"
						href="/lagou1/HR/createResume.jsp">发布职位</a></li>
						<li><a href="HR/companyBasicInfor.jsp">我的公司</a></li>
    				    			<!-- <li><a rel="nofollow" href="/lagou1/HR/canDealResumes.jsp">简历管理</a></li> -->
	    						    		</ul>
        	        	<dl class="collapsible_menu">
            	<dt>
           			<span>${ sessionScope.companyinfo.companyName }&nbsp;</span> 
            		<span class="red" id="noticeDot-0"></span>
            		<i></i>
            	</dt>
                                	<!-- <dd><a rel="nofollow" href="/lagou1/HR/canDealResumes.jsp">简历管理</a></dd>
                	                	<dd><a href="/lagou1/jobSeeker/collectionsRes.jsp">我收藏的职位</a></dd>
                	                	                	<dd><a href="/lagou1/jobSeeker/deliveryResume.jsp">我投递的职位 <span id="noticeNo" class="red">(1)</span></a></dd>
                	                	<dd class="btm"><a href="/lagou1/jobSeeker/mySubscribedJob.jsp">我的订阅</a></dd> -->
                	<dd><a href="/lagou1/HR/createResume">我要招人</a></dd>
                                                <dd><a href="accountBind.jsp">帐号设置</a></dd>
                                <dd class="logout"><a rel="nofollow" href="/lagou/login.jsp">退出</a></dd>
            </dl>
                                    <div id="noticeTip">
            	<span class="bot"></span>
				<span class="top"></span>
    ...
    <div id="container">
                	<div class="sidebar">
        		            	<a class="btn_create" href="/lagou1/HR/createResume.jsp">发布新职位</a>
            	                <dl class="company_center_aside">
		<dt>我收到的简历</dt>
		<dd class="current">
		<a href="/lagou1/findResumeBystatus/canDealResumes.action?status=2">待处理简历</a> 
			</dd>
	<dd >
		<a href="/lagou1/findResumeBystatus/canInterviewResumes.action?status=4">待定简历</a>
	</dd>
	<dd>
		<a href="/lagou1/findResumeBystatus/haveNoticeResumes.action?status=5">已通知面试简历</a>
	</dd>
	<dd>
		<a href="/lagou1/findResumeBystatus/findByResumeStatuss.action?status=6">不合适简历</a>
	</dd>
...
<dl class="company_center_aside">
		<dt>我发布的职位</dt>
			<dd>
					    <a href="/lagou1/companyjobinfo/find.action?status=1">有效职位</a>
						<!-- <a href="/lagou1/HR/existPositions.jsp">有效职位</a> -->
					</dd>
					<dd>
					<a href="/lagou1/companyjobinfo/find.action?status=2">已下线职位</a>
						<!-- <a href="/lagou1/HR/existPositions.jsp">已下线职位</a> -->
					</dd>
	</dl>
            </div><!-- end .sidebar -->
            <div class="content">
            	<dl class="company_center_content">
                    <dt>
                        <h1>
                            <em></em>
                           待处理简历 <span>（共${fn:length(requestScope.resumeList)}份）</span>                        </h1>
                    </dt>
                    <dd>
     ...
     <dl>
     	<dt>工作经验：</dt>
         <dd>
         	         	<a rel="-1" class="current" href="/lagou1/findResumeBystatus/canDealResumes.action?jobexp=1&status=2">不限</a>
         	         	<a rel="1" href="/lagou1/findResumeBystatus/canDealResumes.action?jobexp=2&status=2">应届毕业生</a>
         	         	<a rel="2" href="/lagou1/findResumeBystatus/canDealResumes.action?jobexp=3&status=2">一年以下</a>
         	         	<a rel="3" href="/lagou1/findResumeBystatus/canDealResumes.action?jobexp=4&status=2">1-3年</a>
         	         	<a rel="4" href="/lagou1/findResumeBystatus/canDealResumes.action?jobexp=5&status=2">3-5年</a>
         	         	<a rel="5" href="/lagou1/findResumeBystatus/canDealResumes.action?jobexp=6&status=2">5-10年</a>
         	         	<a rel="6" href="/lagou1/findResumeBystatus/canDealResumes.action?jobexp=7&status=2">10年以上</a>
     ...
     <dl>
     	<dt>最低学历：</dt>
         <dd>
         	         	<a rel="-1" class="current" href="/lagou1/findResumeBystatus/canDealResumes.action?jobedu=5&status=2">不限</a>
         	         	<a rel="1" href="/lagou1/findResumeBystatus/canDealResumes.action?jobedu=1&status=2">大专及以上</a>
         	         	<a rel="2" href="/lagou1/findResumeBystatus/canDealResumes.action?jobedu=2&status=2">本科及以上</a>
         	         	<a rel="3" href="/lagou1/findResumeBystatus/canDealResumes.action?jobedu=3&status=2">硕士及以上</a>
         	         	<a rel="4" href="/lagou1/findResumeBystatus/canDealResumes.action?jobedu=4&status=2">博士及以上</a>
     ...
     <input type="hidden" value="" name="positionId" id="positionId">
		  ...
		  <c:forEach items="${requestScope.resumeList }" var="resume">
			                                ...
			                                <div class="resumeShow">
			                                        ...
			                                        <h3 class="unread">
																	                                        	<a target="_blank" title="预览${resume.resumeinfo.userinfo.userinfoUsername }的简历" href="resumeView.jsp?deliverId=1686182">
			                                        				                                            ${resume.resumeinfo.userinfo.userinfoUsername }的简历
			                                        	</a>
			                                        					                           	 			<em></em>
			                                        </h3> 
			                                        <!-- <span class="fr">投递时间：2017-06-01 17:08</span> -->
			                                        <div> 
			                                        	${resume.resumeinfo.userinfo.userinfoUsername }  			                                        	 / ${resume.resumeinfo.userinfo.userinfoSex } 			                                        	/ ${resume.resumeinfo.useredu.jobedu.eduName }			                                        	/ ${resume.resumeinfo.userinfo.userinfoEdu }年  			                                        	/ ${resume.resumeinfo.expectjob.cityinfo.cityName } 			                                           				                                        		<br>
			                                            	${resume.resumeinfo.expectjob.expectJobDept } · ${sessionScope.companyinfo.companyName } | ${resume.resumeinfo.useredu.jobedu.eduName } · ${resume.resumeinfo.useredu.eduSchool }
			                                            			                                        </div>
			                                        <div class="jdpublisher">
				                                        <span>
				                                        	应聘职位：<a title="${resume.jobinfo.jobName }" target="_blank" href="http://www.lagou.com/jobs/149594.jsp">${resume.jobinfo.jobName }</a>
				                                       						                                        </span>
			                                        </div>
			                                    </div>
			                                    <div class="links">
		                                        	<%-- <a data-resumename="${resume.resumeinfo.userinfo.userinfoUsername }的简历" data-positionname="${resume.jobinfo.jobName }" data-deliverid="1686182" data-positionid="149594" data-resumekey="1ccca806e13637f7b1a4560f80f08057" data-forwardcount="1" class="resume_forward" href="javascript:void(0)">
                                                    	转发
                                                    	                                                    	<span>(1人)</span>
                                                    class="resume_del"	                                                    </a>
                                                    <a class="resume_del" href="javascript:void(0)">删除</a> --%>
                                                    <a  href="/lagou1/updateResumeBystatus/canInterviewResumes.action?jobdeliverId=${resume.deliverId}&status=4">待定</a>
                                                    <a  href="/lagou1/updateResumeBystatus/haveNoticeResumes.action?jobdeliverId=${resume.deliverId}&status=5">通知面试</a>
                                                    <a  href="/lagou1/updateResumeBystatus/haveRefuseResumes.action?jobdeliverId=${resume.deliverId}&status=6">不合适</a>
			                                    </div>
			                                </div>
			                                </c:forEach>
			                                <!-- 循环结束 -->
                  ...
                  <span  style="width:700px;height:60px; font-size:35px; margin-left:200px;  color: green;">查询无结果!</span>
                </c:if>
                    </dd>
