...
<script type="text/javascript">
	$(function() {
		$.ajax({
				type : "POST",
				url : "${pageContext.request.contextPath }/jobinfo/findhot.action",
				data : {
				},
				dataType : "text",
	...
	$(function() {
		$("#findnew").click(function() {
			$.ajax({
				type : "POST",
				url : "${pageContext.request.contextPath }/jobinfo/findnew.action",
				data : {
				},
				dataType : "text",
				success : function(data) {
    		...
    		<ul class="reset" id="navheader">
    			...
    			<c:if test="${not empty sessionScope.userinfo }">
    				    			...
    				    			<c:if test="${not empty sessionScope.companyinfo }">
	    							    			<li ><a href="HR/createResume.jsp" rel="nofollow">发布职位</a></li>
	    							    			<li ><a href="HR/companyBasicInfor.jsp" rel="nofollow">我的公司</a></li>
	    							    			</c:if>
	    		    		</ul>
        	            <ul class="loginTop">
            	<li>
    ...
    <div id="container">
		...
		<div id="sidebar">
			<div class="mainNavs">
						...
						<div class="menu_main">
							<h2>技术 <span></span></h2>
				<a href="jobinfo/search.action?typeId=8">Java</a>
				<a href="commonJsp/jobList.jsp">前端开发</a>
				<a href="commonJsp/jobList.jsp">PHP</a>
				<a href="jobinfo/search.action?typeId=12">C</a>
				<a href="jobinfo/search.action?typeId=9">C++</a>
				<a href="commonJsp/jobList.jsp">Android</a>
				<a href="commonJsp/jobList.jsp">iOS</a>
				<a href="commonJsp/jobList.jsp">测试</a>
				<a href="commonJsp/jobList.jsp">技术经理</a>
				<a href="commonJsp/jobList.jsp">项目经理</a>
				<a href="commonJsp/jobList.jsp">架构师</a>
			</div>
					   	<div class="menu_sub dn">
					   								    	<dl class="reset">
					        							        		<dt>
					        			<a href="commonJsp/jobList.jsp">
					        									            								            							            								            							            								            							            								            							            								            							            								            						        				后端开发
					        			</a>
					        		</dt>
						        	<dd>
			...
			<a class="subscribe" href="jobSeeker/findsession.action" target="_blank">订阅职位</a>
		</div>
        <div class="content">	
	        			<div id="search_box">
		<form id="searchForm" name="searchForm" action="jobList.jsp" method="get">
        <ul id="searchType">
...
<dl class="hotSearch">
	<dt>热门搜索：</dt>
	<dd><a href="commonJsp/jobList.jsp">Java</a></dd>
	<dd><a href="commonJsp/jobList.jsp">PHP</a></dd>
	<dd><a href="commonJsp/jobList.jsp">Android</a></dd>
	<dd><a href="commonJsp/jobList.jsp">iOS</a></dd>
	<dd><a href="commonJsp/jobList.jsp">前端</a></dd> 
	<dd><a href="commonJsp/jobList.jsp">产品经理</a></dd>
	<dd><a href="commonJsp/jobList.jsp">UI</a></dd>
	<dd><a href="commonJsp/jobList.jsp">运营</a></dd>
	<dd><a href="commonJsp/jobList.jsp">BD</a></dd>
	<dd><a href="commonJsp/jobList.jsp">实习</a></dd>
</dl>			
			<div id="home_banner">
	            <ul class="banner_bg">
            ...
            <ul class="reset hotabbing">
            	            		<li class="current"  id="findhot" >热门职位</li>
            	            	<li  id="findnew">最新职位</li><c:if test="${ not empty sessionScope.userinfo }">
            	            	<li  id="findsubs">推荐职位</li></c:if>
            </ul>
            <div id="hotList">
	            <ul class="hot_pos reset" id="jakerposul1">
			                	...
			                	<div class="hot_pos_r">
			                        ...
			                        <ul class="companyTags reset">
	                	                ...
	                	                <a href="commonJsp/recommendJob.jsp" class="btn fr" target="_blank">查看更多</a>
	                	            </ul>
	            <ul class="hot_pos hot_posHotPosition reset" id="jakerposul2" style="display:none;">
	            		            		            				            		<li class="clearfix">
		            				            					                	<div class="hot_pos_l">
			                    	<div class="mb10">
	             ...
	             <c:if test="${ not empty sessionScope.userinfo }">
	             <ul class="hot_pos hot_posHotPosition reset" id="jakerposul3" style="display:none;">
	            		            		            				            		<li class="clearfix">
		            				            					                	<div class="hot_pos_l">
			                    	<div class="mb10">
			                        	<a href="h/jobs/149389.jsp" target="_blank">高级PHP研发工程师</a> 
...
<script type="text/javascript" src="style/js/count.js"></script>
	...
	<div id="footer">
		<div class="wrapper">
			<a href="commonJsp/about.jsp" target="_blank" rel="nofollow">联系我们</a>
