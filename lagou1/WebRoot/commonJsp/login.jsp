...
<body id="login_bg">
	<!-- <form action="companyinfo/login.action" method="post">
		<input type="text"  name="email" value=""  />
		<input type="password"  name="password"  />
		<input   type="submit" value="哈哈哈哈哈哈">
	</form> -->
	<div class="login_wrapper">
    	...
    	<input type="hidden" id="resubmitToken" value="" />		
		 <div class="login_box">
        	...
        	<form id="loginForm" action="commonJsp/login.action" method="post">
        	<ul class="register_radio clearfix">
				...
				<input type="text" id="email" checked name="email" value="" tabindex="1" placeholder="请输入登录邮箱地址" />
			  	
			  	<input type="password" id="password" name="password" tabindex="2" placeholder="请输入密码" />
				<!-- <input   type="submit" value=""> -->
				<span class="error" style="display:none;" id="beError"></span><span style="color:red;">${requestScope.errorMessage }</span>
			    <label class="fl" for="remember"><input type="checkbox" id="remember" value="" checked="checked" name="autoLogin" /> 记住我</label>
			    <a href="findPass1.jsp" class="fr" target="_blank">忘记密码？</a>
			    
				<input type="submit" id="submitLogin" value="登 &nbsp; &nbsp; 录"  class="submitLogin"/>
				<!-- <a style="color:#fff;" href="/lagou/index.jsp" class="submitLogin" title="登 &nbsp; &nbsp; 录"/>登 &nbsp; &nbsp; 录</a> -->
			...
			<div class="login_right">
				<div>还没有拉勾帐号？</div>
				<a  href="commonJsp/register.jsp"  class="registor_now">立即注册</a>
