    	...
    	<div class="wrapper">
    		...
    		<ul class="reset" id="navheader">
    			...
    			<li ><a href="companylist.jsp" >公司</a></li>
    				    			<li ><a href="jobdeliver/findByUser.action" rel="nofollow">我的简历</a></li>
    ...
    <div id="container">
            ...
            <div class="content_l">
                    ...
                    <dt>
                        <h1 title="内容运营" >
                            <em></em>
                                                        	<div>${requestScope.jobinfo.jobDepartment } </div>
                           	                           	${requestScope.jobinfo.jobName }
                        </h1>
                    ...
                    <dd class="job_request">
                    	<span class="red">${requestScope.jobinfo.jobHighsal }-${requestScope.jobinfo.jobLowsal }</span>
                       	<span>${requestScope.jobinfo.jobCity }</span> 
                       	<span> ${requestScope.jobinfo.jobexp.expName }</span>
                       	<span> ${requestScope.jobinfo.jobedu.eduName }</span> 
                       	<span>${requestScope.jobinfo.jobprop.propName }</span><br />
                      	  职位诱惑 : ${requestScope.jobinfo.jobAdvantage }
                      	<div>发布时间：3天前发布</div>
                      		<form action="jobinfo/save.action" method="post">
								<input type="hidden" name="jobdelivervo.jobId" value="${requestScope.jobinfo.jobId }"/>
							 	<input type="hidden"  name="jobdelivervo.statusId" value="2">
								<input id="search_button" type="submit" value="投个简递"/> <!-- class="bar_login inline" -->
							</form>
                    </dd>
                    <dd class="job_bt">
                        <h3 class="description">职位描述</h3>
                        <p>岗位职责：  ${requestScope.jobinfo.jobDescripe }</p>
                    </dd>
                     ...
                     <%-- <form action="jobinfo/save.action" method="post">
						<input type="hidden" name="jobdelivervo.jobId" value="${requestScope.jobinfo.jobId }"/>
						 <input type="hidden"  name="jobdelivervo.statusId" value="2">
						<input type="submit" value="投个简递"/> <!-- class="bar_login inline" -->
					</form> --%>
                    ...
                    <dd>
                        ...
                        <div id="addLabel" class="addLabel dn">
                            ...
                            <input type="submit" id="add" value="贴上" />
                       	                       	...
                       	                       	<h4>工作地址</h4>
                       	<div>${requestScope.jobinfo.jobAddress }</div>
                       	<div id="smallmap"></div>
...
<!-- 投递简历时  - 设置默认投递简历 -->
	<div id="setResumeApply" class="popup" style="height:280px;">
	    <table width="100%">
	    	...
	    	<tr>
	        	<td>
                    <form  id="resumeSendForm" class="resumeSetForm"  method="post" action="jobdeliver/save.action">
	            		<label class="radio">
	            			<input type="radio" name="transientInstance.resumeinfo.resumeId" class="resume1" value="1"  />
	            			在线简历：
	            				            				<span class="red">在线简历还不完善，请完善后选择投递</span>
	            				            		</label>
            			<div class="setBtns">
	            		...
	            		<div class="clear"></div>
	            		<label class="radio">
	            			<input type="radio" name="transientInstance.resumeinfo.resumeId" class="resume0" value="0"  />
	            			附件简历：
	            				            				<span class="uploadedResume red">暂无附件简历</span>
	            				            		</label>
	            		<div class="setBtns">
